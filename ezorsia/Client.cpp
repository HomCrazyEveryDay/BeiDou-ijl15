...
void Client::UpdateGameStartup() {
	...
	Memory::WriteDouble(0x00AFE8A0, setAtkOutCap);	// �����ʾ���ޣ�Ĭ��199999��double 8�ֽ�
...
void Client::Chinese() {
	...
	if(SwitchChinese) {
		...
		// ������ѡ��
		Memory::WriteString(0x00AF2B28, "������     ");
		Memory::ReplaceString(0x00B3C0D4, "�Ѹ������ã�\r\n'%s'���Խ������Ļ���", "Change has been made so\r\n'%s' can receive whisper.");

		// �����б���ʾ
		Memory::ReplaceString(0x00AF0738, "Ĭ�Ϸ���", "Default Group");
		Memory::ReplaceString(0x00B3C158, "˫�����Ͷ��š�", "Double-click to send a note.");
		Memory::ReplaceString(0x00B3C194, "˫���޸ķ��顣", "Double-click to make changes to the group.");
