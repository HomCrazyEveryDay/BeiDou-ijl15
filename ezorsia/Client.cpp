...
/*
客户端补丁层内部默认值：
- 允许 config.ini 覆盖：输入法、分辨率、服务器地址、服务器端口。
- 固定为发行包策略：消息数量、登录框、窗口模式、跳过 Logo、汉化、Tubi、面板上限、移动/爬绳、聊天限制、debug 和免密。
- 不再从 config.ini 读取敏感项，避免玩家通过公开配置覆盖战斗、登录、聊天等行为。
*/
...
int Client::setDamageCap = 1999999;
