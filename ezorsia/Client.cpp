...
// ‰ª•‰∏ã‰∏∫ÂÆ¢Êà∑Á´ØË°•‰∏ÅÂ±ÇÂÜÖÈÉ®ÈªòËÆ§ÂÄº„ÄÇÈô§ËæìÂÖ•Ê≥ï„ÄÅÂàÜËæ®Áéá„ÄÅÊúçÂä°Âô®Âú∞ÂùÄÂíåÁ´ØÂè£Â§ñÔºå
// ‰∏çÂÜç‰ªé config.ini ËØªÂèñÔºåÈÅøÂÖçÂÖ¨ÂºÄÈÖçÁΩÆË¶ÜÁõñÊàòÊñó„ÄÅÁôªÂΩï„ÄÅËÅäÂ§©Á≠âÊïèÊÑüË°å‰∏∫„ÄÇ
int Client::m_nGameHeight = 720; // Ê∏∏ÊàèÁ™óÂè£È´òÂ∫¶ÔºåÂÖÅËÆ∏ config.ini Ë¶ÜÁõñ
int Client::m_nGameWidth = 1280; // Ê∏∏ÊàèÁ™óÂè£ÂÆΩÂ∫¶ÔºåÂÖÅËÆ∏ config.ini Ë¶ÜÁõñ
int Client::MsgAmount = 10; // Âè≥‰∏ãËßíÊ∂àÊÅØÊòæÁ§∫Êï∞ÈáèÔºåÂèëË°åÂåÖÂõ∫ÂÆö
bool Client::CustomLoginFrame = true; // ‰ΩøÁî®ÂàÜËæ®ÁéáÈÄÇÈÖçÂêéÁöÑÁôªÂΩïÊ°ÜËµÑÊ∫ê
bool Client::WindowedMode = true; // Âº∫Âà∂Á™óÂè£Ê®°Âºè
bool Client::RemoveLogos = true; // Ë∑≥ËøáÂêØÂä® Logo Âä®Áîª
int Client::setDamageCap = 1999999; // Áâ©ÁêÜÊîªÂáªÈù¢ÊùøÊòæÁ§∫‰∏äÈôê
int Client::setMAtkCap = 1999; // È≠îÊîª/È≠îÈò≤Èù¢ÊùøÊòæÁ§∫‰∏äÈôê
int Client::setAccCap = 999; // ÂëΩ‰∏≠Èù¢ÊùøÊòæÁ§∫‰∏äÈôê
int Client::setAvdCap = 999; // ÂõûÈÅøÈù¢ÊùøÊòæÁ§∫‰∏äÈôê
double Client::setAtkOutCap = 1999999; // ÁúüÂÆûËæìÂá∫ÊòæÁ§∫‰∏äÈôê
bool Client::useTubi = true; // ÂêØÁî® Tubi Ë°•‰∏ÅÔºåÂáèÂ∞ëÂçáÁ∫ßÂíåÂÆ†Áâ©ÊãæÂèñÊó∂ÁöÑÂÆ¢Êà∑Á´ØÂÅúÈ°ø
bool Client::bigLoginFrame = true; // ÁôªÂΩïÁïåÈù¢‰ΩøÁî®Â§ßËæπÊ°ÜÂ∏ÉÂ±Ä
bool Client::SwitchChinese = true; // ÂêØÁî®ÂÆ¢Êà∑Á´ØÊñáÂ≠óÊ±âÂåñË°•‰∏Å
int Client::speedMovementCap = 140; // ÁßªÂä®ÈÄüÂ∫¶‰∏äÈôê
bool Client::noPassword = false; // ÂÖçÂØÜÊ®°ÂºèÔºåÂèëË°åÂåÖÂõ∫ÂÆöÂÖ≥Èó≠
bool Client::debug = false; // Ë∞ÉËØïÊ®°ÂºèÔºåÂèëË°åÂåÖÂõ∫ÂÆöÂÖ≥Èó≠
bool Client::climbSpeedAuto = false; // Áà¨Áª≥ÈÄüÂ∫¶ÊòØÂê¶ÈöèÁßªÂä®ÈÄüÂ∫¶Ëá™ÈÄÇÂ∫î
float Client::climbSpeed = 1.0; // Âõ∫ÂÆöÁà¨Áª≥Âü∫Á°ÄÈÄüÂ∫¶Á≥ªÊï∞
unsigned char Client::imeType = 1; // ËæìÂÖ•Ê≥ï‰øÆÂ§çÊñπÊ°àÔºåÂÖÅËÆ∏ config.ini Ë¶ÜÁõñ
std::string Client::ServerIP_AddressFromINI = "127.0.0.1"; // ÊúçÂä°Âô®Âú∞ÂùÄÔºåÂÖÅËÆ∏ config.ini Ë¶ÜÁõñ
int Client::serverIP_Port = 8484; // ÊúçÂä°Âô®Á´ØÂè£ÔºåÂÖÅËÆ∏ config.ini Ë¶ÜÁõñ
bool Client::talkRepeat = false; // ÊòØÂê¶ÂÖÅËÆ∏ÈáçÂ§çÂèëÈÄÅÁõ∏ÂêåËÅäÂ§©ÂÜÖÂÆπÔºåÂèëË°åÂåÖÂõ∫ÂÆöÂÖ≥Èó≠
int Client::talkTime = 2000; // ËøûÁª≠ËÅäÂ§©Èó¥ÈöîÈôêÂà∂ÔºåÂçï‰ΩçÊØ´Áßí
...
void Client::UpdateGameStartup() {
	...
	Memory::WriteInt(0x007519C1 + 1, serverIP_Port);//µ«¬º∂Àø⁄
	...
	Memory::WriteInt(0x0077E055 + 1, 2147483646); // ŒÔπ•PAD œ‡πÿæﬂÃÂ≤ª√˜£¨ƒ¨»œ÷µ1999£¨int 4◊÷Ω⁄
	Memory::WriteInt(0x0077E12F + 1, 2147483646); // ººƒ‹ œ‡πÿæﬂÃÂ≤ª√˜£¨ƒ¨»œ÷µ1999£¨int 4◊÷Ω⁄
	Memory::WriteInt(0x008C3304 + 1, setDamageCap); // ŒÔπ•√Ê∞Â£¨ƒ¨»œ÷µ199999£¨int 4◊÷Ω⁄
	Memory::WriteInt(0x0077E215 + 1, setMAtkCap); // ƒßπ•√Ê∞Â£¨int 4◊÷Ω⁄
	Memory::WriteInt(0x00780620 + 1, setMAtkCap); // ƒßπ•√Ê∞Â£¨int 4◊÷Ω⁄
	Memory::WriteInt(0x007806D0 + 1, setAccCap); // √¸÷–£¨ƒ¨»œ999
	Memory::WriteInt(0x00780702 + 1, setAvdCap); // ªÿ±‹£¨ƒ¨»œ999
	Memory::WriteInt(0x0078FF5F + 1, 2147483646); // º∆À„ŒÔ¿Ì…À∫¶œ‡πÿ£¨“‚“Â≤ª√˜£¨ƒ¨»œ1999£¨int 4◊÷Ω⁄
	Memory::WriteInt(0x0079166C + 1, 2147483646); // º∆À„ƒßπ•MDamageµƒ£¨ƒ¨»œ÷µ1999£¨int 4◊÷Ω⁄£¨◊¢“‚£∫’‚¿Ô≤ª∏ƒµƒª∞£¨¥Úπ÷ ‰≥ˆº∆À„µƒƒß∑®…À∫¶æÕ «∞¥1999º∆À„µƒ
	Memory::WriteInt(0x00791CD5 + 1, 2147483646); // º∆À„ƒßπ•MDamageµƒ£¨ƒ¨»œ÷µ1999£¨int 4◊÷Ω⁄£¨◊¢“‚£∫’‚¿Ô≤ª∏ƒÀ∆∫ı“≤≤ª”∞œÏ ‰≥ˆº∆À„
	Memory::WriteInt(0x0078E061 + 1, 2147483646); //CalcDamage::PDamage 999£¨“‚“Â≤ª√˜£¨int 4◊÷Ω⁄
	Memory::WriteInt(0x0078E67D + 1, 2147483646); //CalcDamage::PDamage 999£¨“‚“Â≤ª√˜£¨int 4◊÷Ω⁄
	Memory::WriteInt(0x007918FC + 1, 2147483646); //CalcDamage::MDamage 999£¨“‚“Â≤ª√˜£¨int 4◊÷Ω⁄

	Memory::WriteDouble(0x00AFE8A0, setAtkOutCap);	//  ‰≥ˆœ‘ æ…œœﬁ£¨ƒ¨»œ199999£¨double 8◊÷Ω⁄
	...
	Memory::CodeCave(skillToolTipNew, 0x008F383E, 6);	//–ﬁ∏¥ººƒ‹√Ë ˆ÷–Œƒªª––¬“¬ÎµƒŒ Ã‚
...
void Client::UpdateResolution() {
	...
	Memory::WriteInt(0x008DA11C + 1, m_nGameHeight - 19);	//push 581 ¡Ÿ ±æ≠—ÈÃı
	...
	Memory::WriteInt(0x00523092 + 1, 423);// Ωª“◊…Í«Î∆¯≈›x◊¯±Í
...
void Client::Chinese() {
	...
	if(SwitchChinese) {
		// ¡ƒÃÏ¿∏—°œÓ
		Memory::WriteString(0x00AF2B28, "∂‘¡™√À     ");
		...
		// ÕÊº“√˚∆¨ ÷∞“µ◊÷ÃÂ¥Û–°∫ÕŒª÷√
		Memory::WriteByte(0x0090142E + 1, 0x5E); // 60->5E Œª÷√…œ“∆
		Memory::WriteByte(0x00901400 + 1, 1); // ◊÷ÃÂtype∏ƒŒ™1 ∂‘”¶12∫≈¥Û–°
	}
}
...
void Client::MoreHook() {
	...
	Memory::WriteByte(0x008EC4A7 + 1, 0x23);//◊∞±∏ Ù–‘“≥√Êµƒ÷∞“µ–Ë«Û∆´“∆’Ω ø
	Memory::WriteByte(0x008EC53C + 1, 0x4D);//ƒß∑® ¶
	Memory::WriteByte(0x008EC5D1 + 1, 0x7A);//π≠º˝ ÷
	Memory::WriteByte(0x008EC660 + 1, 0xA9);//∑…œ¿
	Memory::WriteByte(0x008EC6CF + 1, 0xC8);//∫£µ¡
	...
	{
		Memory::WriteInt(0x008C485A + 1, 192); // √Ê∞Âπÿ±’∞¥≈•x
		Memory::WriteInt(0x008C4AB3 + 1, 210); // √Ê∞ÂøÌ∂»
		Memory::WriteInt(0x008C510A + 1, 218); // œÍ«È√Ê∞ÂøÌ∂»
		Memory::WriteInt(0x008C4EA2 + 1, 210); // œÍ«È√Ê∞Â≥ı ºx
		Memory::WriteInt(0x008C5760 + 1, 210); // œÍ«È√Ê∞Â«–ªªx
		Memory::WriteInt(0x008C7AD9 + 1, 185); // º” Ù–‘∞¥≈•x
		Memory::WriteInt(0x008C2754 + 1, 195); // œÍ«È√Ê∞Âπÿ±’∞¥≈•x
		Memory::WriteInt(0x008C6C72 + 1, 210); // “∆∂Ø ±œÍ«È√Ê∞Âx
		Memory::CodeCave(apDetailBtn, 0x008C4E1B, 7); // œÍ«È∞¥≈•
	}
	// ¿Æ∞»
	...
	// ¥∞ø⁄±£¥ÊŒª÷√
	Memory::WriteInt(0x0049D218 + 1, m_nGameWidth - 16);// ¥∞ø⁄±£¥ÊŒª÷√±ﬂΩÁ x
	Memory::WriteInt(0x0049D268 + 1, m_nGameHeight - 16);// ¥∞ø⁄±£¥ÊŒª÷√±ﬂΩÁ y
}
