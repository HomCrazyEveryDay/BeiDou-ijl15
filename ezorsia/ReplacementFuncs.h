...
static bool EzorsiaV2WzIncluded = true;
...
const int maxLevelForCustomEXP = sizeof(myArrayForCustomEXP) / sizeof(myArrayForCustomEXP[0]);//paste your custom exp table's array into the place of myArrayForCustomEXP[]
void* __fastcall _lpfn_NextLevel_Hook(int expTable[maxLevelForCustomEXP + 1])//your max level is the size of your array
{
