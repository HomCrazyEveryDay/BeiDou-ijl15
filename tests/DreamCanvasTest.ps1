...
$output=Join-Path $env:TEMP ('dream-canvas-'+[guid]::NewGuid().ToString('N'))
New-Item -ItemType Directory $output | Out-Null
& cl.exe /nologo /EHsc /std:c++17 "$PSScriptRoot/DreamCanvasTest.cpp" "/Fo$output\" "/Fe$output/test.exe"
